                        ...
                        <td className="py-4 px-6 text-right min-w-[220px]">
                          <div className="flex items-center justify-end gap-2">
                            <Link 
                              ...
                              className="inline-flex items-center gap-1 bg-neutral-900 hover:bg-neutral-800 dark:bg-white dark:hover:bg-neutral-100 text-white dark:text-neutral-900 px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors duration-200"
                            >
                              <span>Manage</span>
                              <ArrowRight size={13} />
                            </Link>
