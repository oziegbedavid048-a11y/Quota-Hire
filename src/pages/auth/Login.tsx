      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between relative z-10 w-full max-w-[1200px] mx-auto gap-8 lg:gap-16">
        ...
        >
          <div className="bg-white/40 dark:bg-neutral-900/40 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_8px_32px_rgba(0,0,0,0.12)] border border-white/60 dark:border-white/10 p-8 sm:p-10 relative overflow-hidden pointer-events-auto">
            ...
            <div className="relative w-full h-[56px] rounded-xl overflow-hidden mb-4 z-10 border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900/60 hover:bg-neutral-50 dark:hover:bg-neutral-800/80 transition-all duration-300 shadow-md">
              {/* Visible Styled Button (User sees this) */}
              ...
              <div 
                ...
                className="absolute inset-0 w-full h-full opacity-[0.01] pointer-events-auto scale-[1.5] origin-center cursor-pointer" 
              />
            </div>
