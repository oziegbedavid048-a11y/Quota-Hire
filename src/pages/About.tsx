...
export const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      {/* Hero */}
      <section className="pt-32 pb-24 relative overflow-hidden bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800">
      ...
      <section className="py-24 bg-neutral-950 text-white relative overflow-hidden">
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 text-white">Our Core Values</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <Target className="w-8 h-8 text-accent-400" />, title: 'Transparency', desc: 'Upfront salary, OTE, and realistic quotas. No hidden surprises.' },
              { icon: <TrendingUp className="w-8 h-8 text-accent-400" />, title: 'Performance', desc: 'We value track records over buzzwords. Numbers speak louder.' },
              { icon: <Users className="w-8 h-8 text-accent-400" />, title: 'Direct Access', desc: 'Eliminating the middleman to connect you straight to the source.' },
            ].map((v, i) => (
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn} className="bg-neutral-900 p-8 rounded-2xl border border-neutral-800">
