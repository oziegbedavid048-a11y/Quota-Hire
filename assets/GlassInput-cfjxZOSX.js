import{r as d,j as e,A as w,m as j}from"./index-Bw5TZTlO.js";import{E as k}from"./eye-off-BsSqe4sa.js";import{E as p}from"./eye-BL34DW3V.js";import{C as y}from"./circle-alert-BufRG7KC.js";const v=d.forwardRef(({icon:r,label:i,error:a,type:c="text",className:m="",...t},b)=>{const[x,u]=d.useState(!1),[l,h]=d.useState(!1);t.value;const o=c==="password",f=o&&l?"text":c;return e.jsxs("div",{className:`relative ${m}`,children:[e.jsx("label",{className:"block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-1.5 ml-1",children:i}),e.jsxs("div",{className:`
