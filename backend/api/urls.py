...
urlpatterns = [
    ...
    path('community/comments/<int:pk>/like/',         views.CommunityCommentLikeView.as_view(),       name='community-comment-like'),
    path('community/comments/<int:pk>/dislike/',      views.CommunityCommentDislikeView.as_view(),    name='community-comment-dislike'),
    path('community/comments/<int:pk>/report/',       views.CommunityCommentReportView.as_view(),     name='community-comment-report'),
