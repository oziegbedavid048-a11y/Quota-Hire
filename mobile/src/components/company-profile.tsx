          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 12, color: "#b91c1c", marginTop: 2 }}>
                We couldn't load your company profile. Tap to retry.
              </Text>
            </View>
            <Pressable
              onPress={() => {
      ...
      >
        ...
        >
          ...
          <View style={styles.heroInfo}>
            ...
            <Text
              style={[styles.heroIndustry, { color: colors.textSecondary }]}
            >
        ...
        >
          <View style={styles.modalBody}>
            ...
            <Pressable
              ...
              style={[styles.saveBtn, { backgroundColor: Palette.accent600 }]}
            >
              {saving ? (
